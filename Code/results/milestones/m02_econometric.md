...
*Generated by `python -m src.experiments.run_econometric` on 2026-09-02 02:35 UTC. All numbers trace to `results/tables/m02_*_metrics.csv` and `results/predictions/m02_*.parquet`.*
